  ...
  <div className="team_background">
    <div className="team_container">
      <div className="team_column left">
        ...
        <div className="team_info">Pour garder un œil averti sur les séries et films qui sont d'actualité, nous avons concocter ce petit site en React, qui tire toutes ses infos de l'api <a className="team_info_links" target="_blank" rel=" noopener noreferrer" href="https://www.themoviedb.org/">TheMovieDB</a>, notre site est herbégé sur GitHub. On espère que vous apprécierez la visite.</div>
      </div>
