              ...
              <section className="desktop_details_presentation_infos">
                ...
                <div className="desktop_details_column_details">
                  ...
                  <div className={classNames(
                    { desktop_rating_background: classList({ note }) },
                    { desktop_rating_background_class1: classList({ note }) },
                    { desktop_rating_background_class2: classList({ note }) },
                  )}
                  >
                    <h4 className="desktop_rating">{note}</h4>
                  </div>
...
//           case '0':
//             return 'desktop_rating_background';
//           case '1':
//             return <div className="desktop_rating_background"><h4 className="desktop_rating">1</h4></div>;
//           case '2':
//             return <div className="desktop_rating_background"><h4 className="desktop_rating">2</h4></div>;
//           case '3':
//             return <div className="desktop_rating_background"><h4 className="desktop_rating">3</h4></div>;
//           case '4':
//             return <div className="desktop_rating_background"><h4 className="desktop_rating">4</h4></div>;
//           case '5':
//             return <div className="desktop_rating_background--class1"><h4 className="desktop_rating">5</h4></div>;
//           case '6':
//             return <div className="desktop_rating_background--class1"><h4 className="desktop_rating">6</h4></div>;
//           case '7':
//             return <div className="desktop_rating_background--class1"><h4 className="desktop_rating">7</h4></div>;
//           case '8':
//             return <div className="desktop_rating_background--class2"><h4 className="desktop_rating">8</h4></div>;
//           case '9':
//             return <div className="desktop_rating_background--class2"><h4 className="desktop_rating">9</h4></div>;
//           case '10':
//             return <div className="desktop_rating_background--class2"><h4 className="desktop_rating">10</h4></div>;
//           default:
//             return null;
//         }
//       })()}
